...
client = mqtt.connect("test.mosquitto.org", 8883, "ucode-ssl-subscriber", {
    on_connect: function(client) {
            print("Subscriber connected to MQTT broker with SSL!\n");
    ...
    on_disconnect: function(client) {
        print("Subscriber disconnected (SSL)\n");
    },
...
if (client) {
    print("Connecting subscriber to test.mosquitto.org:8883 with SSL...\n");
